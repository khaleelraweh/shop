...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="text-muted text-center font-size-18"><b>إعادة تعيين كلمة المرور</b></h4>
            ...
            <div class="p-3">
                <form class="form-horizontal mt-3" action="{{ route('password.email') }}" class="user">
                    ...
                    <div class="form-group pb-2 text-center row mt-3">
                        <div class="col-12">
                            <button class="btn btn-info w-100 waves-effect waves-light" type="submit" name="submit">Send
                                Email</button>
                        </div>
                    </div>
                </form>
