        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <div class="card-naving">
                <h3 class="font-weight-bold text-primary">
                    ...
                    إضافة شركة دفع إلكترونية جديدة
                </h3>
                <ul class="breadcrumb">
                    <li>
                                    ...
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="driver_name" name="driver_name"
                                                value="{{ old('driver_name') }}" class="form-control" placeholder="">
                                            @error('driver_name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        ...
                                        <select id="mycheck" name="sandbox" class="form-control">
                                            <option value="0" {{ old('sandbox') == '0' ? 'selected' : null }}>تجريبي
                                            </option>
                                            <option value="1" {{ old('sandbox') == '1' ? 'selected' : null }}>حقيقي
                                            </option>
                                        </select>
                                        @error('sandbox')
                                            <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="merchant_email" name="merchant_email"
                                        value="{{ old('merchant_email') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="merchant_password" name="merchant_password"
                                        value="{{ old('merchant_password') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="client_id" name="client_id"
                                        value="{{ old('client_id') }}" class="form-control" placeholder="">
                                    @error('client_id')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="client_secret" name="client_secret"
                                        value="{{ old('client_secret') }}" class="form-control" placeholder="">
                                    @error('client_secret')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="signature" name="signature"
                                        value="{{ old('signature') }}" class="form-control" placeholder="">
                                    @error('signature')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_merchant_email" name="sandbox_merchant_email"
                                        value="{{ old('sandbox_merchant_email') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_merchant_password" name="sandbox_merchant_password"
                                        value="{{ old('sandbox_merchant_password') }}" class="form-control"
                                        placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_client_id" name="sandbox_client_id"
                                        value="{{ old('sandbox_client_id') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_client_secret" name="sandbox_client_secret"
                                        value="{{ old('sandbox_client_secret') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_username" name="sandbox_username"
                                        value="{{ old('sandbox_username') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_password" name="sandbox_password"
                                        value="{{ old('sandbox_password') }}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_signature" name="sandbox_signature"
                                        value="{{ old('sandbox_signature') }}" class="form-control" placeholder="">
