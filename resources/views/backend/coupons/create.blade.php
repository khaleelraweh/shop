                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        ...
                                        <select name="type" class="form-control">
                                            <option value="">---</option>
                                            <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : null }}>قيمة
                                                ثابته</option>
                                            <option value="percentage"
                                                {{ old('type') == 'percentage' ? 'selected' : null }}>نسبة المئوية</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <select name="view_in_main" class="form-control">
                                    <option value="1" {{ old('view_in_main') == '1' ? 'selected' : null }}>مفعل
                                    </option>
                                    <option value="0" {{ old('view_in_main') == '0' ? 'selected' : null }}>غير مفعل
                                    </option>
                                </select>
                                @error('view_in_main')
                                    <span class="text-danger">{{ $message }}</span>
